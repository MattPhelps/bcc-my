...
const reviewsData: Review[] = [
  {
    ...
    userImage: "/images/user/user2.jpeg",
    description:
      "This is so cool! Gonna stop browsing Pinterest and going to give this a try for my next tattoo 🤩",
  },
  {
    id: 2,
    userName: "Alfred Montgomery",
    userImage: "/images/user/user1.jpeg",
    description:
      "Damn so cool! Can't wait to try it out.",
  },
  {
    id: 3,
    userName: "Marvin Williamson",
    userImage: "/images/user/user7.webp",
    description:
      "Nice idea and I look forward to the designs being more higher res, water colours seem limited as were the images. It would be good to have longer than 8 free attempts to find your perfect design. Really do love this concept though and good luck!",
  },
  {
    id: 38,
    userName: "David Hudson",
    userImage: "/images/user/user11.jpeg",
    description:
      "I don't have any tattoos because I don't like the ideas",
  },
  {
    id: 8,
  ...
  {
    id: 14,
    userName: "Minni Bowers",
    userImage: "/images/user/user4.avif",
    description:
      "This is insanely cool! Will definitely try this out for my next tattoo!",
  },
  {
    id: 801,
    userName: "Dylan Cole",
    userImage: "/images/user/user5.jpeg",
    description:
      "I said I would do it. Thanks for this marvelous tool ... AI-generated tattoos, copy-pasted to my body thanks to BlackInk AI ",
  },

  {
    id: 3,
    userName: "Tyler Brooks",
    userImage: "/images/user/user6.jpeg",
    description:
      "To be completely honest, it is one of, if not the best art AI I have ever used. It works so well that my friend is even getting a tattoo of an image made by it.",
  },
  
  {
    id: 5,
    userName: "Vera Pearson",
    userImage: "/images/user/user10.jpeg",
    description:
  ...
  {
    id: 7,
    userName: "Geri Salazaar",
    userImage: "/images/user/user3.jpeg",
    description:
      "This is a great idea! Could help people articulate to their tattoo artist what they have in mind. Is it me or does it look like there’s just one “style” of tattoo though? I haven’t tried it myself, just judging by the screenshots, there doesn’t seem to be much variety. (More like everything was made by the same ‘person’, which in a way, it has",
  },
  {
    id: 101,
    userName: "Steven McCarthy",
    userImage: "/images/user/user9.avif",
    description:
      "where was this when I was trying to figure out what to put on my sleeve 😅",
  },
  {
    id: 82,
    userName: "Max Larson",
    userImage: "/images/user/user8.jpeg",
    description:
      "Will be using this next time I get a tattoo too!",
  },
];
