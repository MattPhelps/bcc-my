...
const SingleReview = ({ review }: { review: Review }) => {
  return (
    <div className="user-border-gradient relative bg-[#f3f3f3] overflow-hidden rounded-[19px] px-8 py-9">
      <div className="flex items-center gap-4.5">
        ...
        <div>
          <h3 className="text-sm font-medium text-black">{review.userName}</h3>
        </div>
      </div>

      <div className="user-divider relative my-2 h-[1px] w-full"></div>
